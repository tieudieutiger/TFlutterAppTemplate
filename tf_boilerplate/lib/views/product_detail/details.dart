...
import 'package:tf_boiderplate/models/fruit.dart';
import 'package:tf_boiderplate/utils/constants.dart';
import 'package:tf_boiderplate/widgets/rating_bar.dart';

class ProductDetailsPage extends StatelessWidget {
  final Fruit fruit;
  const ProductDetailsPage({Key key, this.fruit}) : super(key: key);
